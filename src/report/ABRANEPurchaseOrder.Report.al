report 50015 "ABRANE : Purchase Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/ReportLayout/ABRANEPurchaseOrder.rdlc';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(LabelJob; JobLbl)
            {
            }
            column(LabelSite; SiteLbl)
            {
            }
            column(LabelDu; DuLbl)
            {
            }
            column(LabelQty; QtyLbl)
            {
            }
            ...
            column(labelVariant; VariantLbl)
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(Variante; "Purchase Line"."Variant Code")
                        {
                        }
                        column(HSCode_PurchLine; HSCode_wTxt)
                        {
                        }
                        column(BlanketOrderNo; "Purchase Line"."Blanket Order No.")
                        {
                        }
                        ...
                        column(BaseQty_PurchLine; "Purchase Line"."Quantity (Base)")
                        {
                        }
                        column(dTxtRem; dTxtRem)
                        {
                        }
                        ...
                        column(Desc2_PL; "Purchase Line"."Description 2")
                        {
                        }
                        column(VendorItemNo_PL; "Purchase Line"."Vendor Item No.")
                        {
                        }
                        column(VendorItemNoCaption; "Purchase Line".FieldCaption("Vendor Item No."))
                        {
                        }
                        column(ItemGencod; Item."No. client final")
                        {
                        }
                        column(ItemGencodCaption; Item.FieldCaption("No. client final"))
                        {
                        }
                        ...
                        begin
                            ...
                            Clear(HSCode_wTxt);
                            if (PurchLine.Type = PurchLine.Type::Item) and (PurchLine."No." <> '') and (Item."Tariff No." <> '') then
                                HSCode_wTxt := StrSubstNo(HSCodeLbl, Item."Tariff No.");
                    ...
                    dataitem(Total3; "Integer")
                    {
                        ...
                        column(ShipLocationCode; "Purchase Header"."Location Code")
                        {
                        }
                ...
                begin
                    ...
                    //DIA£LBO 12/12/2016
                    if booGroupItem then begin
                        PurchLine.DeleteAll();

                        recPurch.SetRange("Document Type", "Purchase Header"."Document Type");
                        recPurch.SetRange("Document No.", "Purchase Header"."No.");
                        if recPurch.FindSet() then
                            repeat
                                if recPurch.Type = recPurch.Type::Item then begin
                                    PurchLine.Reset();
                                    PurchLine.SetRange("No.", recPurch."No.");
                                    PurchLine.SetRange("Variant Code", recPurch."Variant Code");
                                    PurchLine.SetRange("Unit of Measure Code", recPurch."Unit of Measure Code");
                                    PurchLine.SetRange("Direct Unit Cost", recPurch."Direct Unit Cost");
                                    PurchLine.SetRange("Line Discount %", recPurch."Line Discount %");
                                    if PurchLine.FindFirst() then begin
                                        PurchLine.Quantity += recPurch.Quantity;
                                        PurchLine."Line Discount Amount" += recPurch."Line Discount Amount";
                                        PurchLine."Amount Including VAT" += recPurch."Amount Including VAT";
                                        PurchLine."Line Amount" += recPurch.Amount;
                                        PurchLine.Amount += recPurch."Line Amount";
                                        PurchLine.Modify();
                                    end else begin
                                        PurchLine.Init();
                                        PurchLine := recPurch;
            ...
            begin
                ...
                recDimValue.SetRange(Code, "Purchase Header"."Shortcut Dimension 2 Code");
                ...
                if "Code chantier" <> '' then begin
                    ...
                    recDimValue.SetRange(Code, "Purchase Header"."Shortcut Dimension 1 Code");
                    if recDimValue.FindSet() then
                        CustName := recDimValue.Name
                    else
                        CustName := '';
                end;

                if RecDimSetEntry.Get("Purchase Header"."Dimension Set ID", GLSetup."Shortcut Dimension 3 Code") then begin
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(booGroupItemField; booGroupItem)
                    {
                        Caption = 'Grouper articles';
                        ToolTip = 'Grouper articles';
                    }
                }
            }
        }
    ...
    procedure InitializeSend(pOption: Option "Hard Copy","E-Mail",Fax)
    begin
        OptSend := pOption;
    end;
