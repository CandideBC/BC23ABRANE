report 50069 "Extraire DEB Ventes"
{
    ...
    // //Sur la meme facture, on a vendu la pose de ces tables pour 500Eur. La pose consiste en un article dont le code douanier est 999999 qui ne doit pas etre declaré.
    // //On va alors declarer sur la DEB la vente de 10 tables à 150Eur.
    ...
    dataset
    {
        dataitem("Country/Region"; "Country/Region")
        {
            ...
            {
                DataItemLink = "Ship-to Country/Region Code" = field(Code);
                ...
                dataitem("Sales Invoice Line"; "Sales Invoice Line")
                {
                    ...
                    begin
                        ...
                        LigneDEB."Type ligne DEB" := LigneDEB."Type ligne DEB"::"Expédition";
                        LigneDEB.Date := "Sales Invoice Header"."Posting Date";
                        LigneDEB."Type document" := LigneDEB."Type document"::Facture;
                        LigneDEB."No. document" := "Document No.";
                        LigneDEB."No. ligne document" := "Line No.";
                        LigneDEB."Country/Region Code" := "Sales Invoice Header"."Sell-to Country/Region Code";
                        ...
                        LigneDEB."Shipment Method Code" := "Sales Invoice Header"."Shipment Method Code";
                        LigneDEB."VAT Registration No." := ClientFacture."VAT Registration No.";
                ...
                begin
                    if "Sales Invoice Header"."Facture acompte" then
                        CurrReport.Skip();

                    ClientFacture.Get("Bill-to Customer No.");
                end;

                trigger OnPreDataItem()
                begin
                    SetRange("Sales Invoice Header"."Posting Date", 0D, DateComptaMax);
                end;
            }
        ...
        {
            DataItemTableView = sorting("Date debut periode comptable", "Type ligne DEB", "Type document", "No. document", "No. ligne document") where("Type ligne DEB" = const(expédition), "Type document" = const(Facture));
    ...
    var
        ...
        LigneDEBPourSuppression: Record "Ligne DEB";
        AucunePeriodeOuverteErr: Label 'Aucune période comptable n''a été trouvée pour laquelle la DEB n''ait pas déjà été validée.';
